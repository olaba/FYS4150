...
fig2 = plt.figure(2)
h_100 = plt.plot(h100,topliz100, h100, exact100)
h_100[0].set_ls('--')
plt.title("Results with n = 100")
plt.legend([h_100[0],h_100[1]],["Numerical results", "Exact values"])
plt.show()
...
plt.legend([h_1000[0],h_1000[1]],["Numerical results", "Exact values"])
plt.show()
